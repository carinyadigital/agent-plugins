...
DO NOT INCLUDE in a sprint plan:
  - Gherkin acceptance criteria → .agency/work/{epic}/tasks.md
  - New or re-prioritised epics → .agency/backlog.md
  - Phase re-sequencing or exit criteria → .agency/roadmap.md
