...
description: >
  ...
  (checkout-foundation, CHK01, etc.). Default .agency/work/{epic}/tasks.md. Do NOT use for
...
- **Preferred:** `.agency/work/{epic}/design.md` and the epic row in `.agency/backlog.md`
- **Alternative:** a spec the user provides
- **Context:** `.agency/architecture/solution.md`
...
- **Do not add epics** here — new epics go in `.agency/backlog.md`.
...
2. Resolve `{epic}` and `.agency/work/{epic}/tasks.md`.
