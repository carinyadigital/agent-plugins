...
For eval runs on skills in this repo, use **plugin-eval** from `.agents/skills/plugin-eval/SKILL.md`. Run **skills-qa** from `.agents/skills/skills-qa/SKILL.md` before shipping skill changes.
