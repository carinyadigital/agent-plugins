...
3. **Technical design (tdd)** — `/engineering:tdd <work-id>`
...
Location: `<instance-root>/config/.engineering-setup-resume.json` if instance exists; else personal hub path per framework.
