...
not inferred from the directory name. Delivery artefacts live under `docs/` and
`specs/` as above. Agent byproducts (competitor scans, metrics digests,
stakeholder digests) write under `docs/reviews/`.
