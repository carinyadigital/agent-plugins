...
description: Use this agent when reviewing whether a diff stays within .agency/work/{epic}/design.md scope and cites solution.md correctly. Typical triggers include pre-PR review or detecting scope creep beyond Files shipped. See "When to invoke" in the agent body.
model: inherit
color: cyan
...
1. Read `.agency/work/{epic}/design.md` (scope, files, out of scope).
