...
DO NOT INCLUDE in this design.md:
  ...
  - Story-level acceptance criteria     → .agency/work/{epic}/tasks.md (tasks skill)
...
Design for epic {EPIC-ID} at `.agency/work/{epic}/`. Architecture-wide patterns are authoritative in
